  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="mx-auto max-w-3xl px-4 py-10 md:py-16 w-full flex-1">
        ...
        <div className="prose prose-neutral mt-6 max-w-none text-ink/85 [&_h2]:font-display [&_h2]:text-2xl [&_h2]:font-black [&_h2]:mt-8 [&_p]:mt-3 [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:mt-3 [&_li]:mt-1">
          {children}
        </div>
      </main>
      <SiteFooter />
