...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/eC0JbtLTiTTbERHCIlsliVltk5k2/social-images/social-1785093437509-6210.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/eC0JbtLTiTTbERHCIlsliVltk5k2/social-images/social-1785093437509-6210.webp" },
      { name: "twitter:title", content: "Lucky Git Comps — Win Cars, Cash & Tech in the UK" },
      { name: "twitter:description", content: "UK prize competitions with verified winners and automatic random draws. Cars, tech, cash and holidays from £1." },
    ],
    links: [
      {
        rel: "stylesheet",
