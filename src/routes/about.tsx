...
export const Route = createFileRoute("/about")({
  ...
  component: () => (
    <StaticPage kicker="Us lot" title="About Lucky Git Comps">
      ...
      <p>That said, we take the actual competition part deadly seriously. Every draw is automatic and provably random the moment the timer hits zero, logged with a verification hash on our public Past Draws page. Every winner is real and named. We use Stripe for payments and never touch your card details.</p>
