...
export const Route = createFileRoute("/terms")({
  ...
  component: () => (
    <StaticPage kicker="Legal" title="Terms & Conditions">
      ...
      <h2>2. Entry</h2>
      <p>Entry is by either paid ticket purchase or free postal entry. All entrants must correctly answer the skill question on that competition's page for their entry to count.</p>
      <h2>3. The draw</h2>
