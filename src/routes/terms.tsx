...
export const Route = createFileRoute("/terms")({
  ...
  component: () => (
    <StaticPage kicker="Legal" title="Terms & Conditions">
      ...
      <h2>4. Free entry</h2>
      <p>Every competition may be entered without payment, by post or by email, as described on <a href="/free-entry">/free-entry</a>. Free entries are subject to the same skill question and qualification rules as paid tickets, and carry identical odds within the draw once logged. Each competition reserves a limited number of ticket numbers exclusively for free entries; this number is shown on the competition page. Free entries are logged in the order received. Postal entries must be received (not postmarked) by the stated postal cut-off; email entries must be received by the stated email cut-off. Once the reserved allocation for a competition is fully claimed, or the relevant cut-off has passed, further free entries for that competition are declined and are not transferred to any other competition. Each entrant may submit one free entry per competition, and no more than one free entry across all competitions in any rolling 30-day period.</p>
      <h2>5. The draw</h2>
